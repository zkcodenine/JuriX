...
function tribunalStyle(tribunal) {
  ...
  return { accent: '#C9A84C', bg: 'rgba(201,168,76,.08)', border: 'rgba(201,168,76,.2)' };
}
  ...
  return (
    <div
      ...
      style={{
        ...
        ...(hero ? {
          background: 'linear-gradient(var(--bg-card), var(--bg-card)) padding-box, linear-gradient(135deg, rgba(201,168,76,.55), rgba(59,130,246,.35), rgba(16,185,129,.35)) border-box',
...
export default function Dashboard() {
  ...
  const { isOnline, isUsingCache } = useConnectionStore();
  ...
  return (
    <div style={{ maxWidth: 1400, margin: '0 auto' }} className="animate-fadeIn">
      ...
      <div className="dash-grid-container">
        ...
        <DashCard colSpan="full" hero delay={0}>
          <CardLabel icon="fa-chart-bar" live>Visao Geral</CardLabel>
          ...
          {audienciasHoje.length === 0 && prazosHoje.length === 0 ? (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 10 }}>
              {audienciasHoje.map((a, i) => (
                <div key={a.id} className="group" style={{
                ...
                return (
                  <div key={p.id} style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <div style={{ fontWeight: 600, fontSize: 14 }}>{p.processoNumero}</div>
              ...
              return (
                <div key={day.dStr} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
                  ...
                  <div style={{
                    ...
                    background: day.isToday ? 'var(--accent)' : 'var(--bg-tertiary)',
              ...
              eventosSemana.slice(0, 6).map(e => {
                ...
                return (
                  <div key={e.id} onClick={() => navigate('/agenda')} style={{
                    ...
                    padding: '7px 10px', background: isToday ? 'rgba(201,168,76,.12)' : 'var(--bg-tertiary)',
                ...
                return (
                  <div key={proc.id} className="group" style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                      <div style={{ fontSize: 13, fontWeight: 600 }}>{proc.numero || proc.numeroCnj}</div>
              ...
              {processosLista.map((p, pi) => {
                ...
                return (
                  <div key={p.id} style={{
                    ...
                    <div style={{ flex: 1, fontSize: 12, fontWeight: 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      {p.numero || p.numeroCnj}
                    </div>
        ...
        {notificacoes.length > 0 && (
          <DashCard colSpan="full" delay={560} style={{
            ...
            background: 'linear-gradient(135deg, rgba(167,139,250,.04), rgba(15,23,42,.95))',
          }}>
            <div style={{
              display: 'flex', justifyContent: 'space-between', alignItems: 'center',
