...
import TabAnotacoes     from '../../components/processos/tabs/Anotacoes';
  ...
  const tabContent = {
    ...
    documentos: (
      <div className="space-y-8">
        <TabDocumentos processo={processo} onRefresh={refresh} />
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: '2rem' }}>
          <div className="flex items-center gap-2 mb-4">
            <i className="fas fa-pen-nib text-sm" style={{ color: 'var(--accent)' }} />
            <h3 className="font-bold text-sm">Notas Jurídicas</h3>
          </div>
          <TabAnotacoes processo={processo} onRefresh={refresh} />
        </div>
      </div>
    ),
              ...
              >
                ...
                {count > 0 && (
                  <span
                    ...
                    style={{
                      background: abaAtiva === tab.id ? 'var(--accent)' : 'var(--bg-secondary)',
        ...
        >
          ...
          >
            <div className="flex justify-between items-center px-6 py-4" style={{ borderBottom: '1px solid var(--border)' }}>
              ...
              <button onClick={() => setShowInfoExtra(false)} className="flex items-center justify-center rounded-xl hover:opacity-70 transition-opacity" style={{ width: 34, height: 34, background: 'var(--bg-tertiary)' }}>
            ...
            <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={f.label} className="flex items-start gap-3 rounded-xl px-3 py-2.5" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border)' }}>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    {processo.partes.map(parte => {
                      ...
                      return (
                        <div key={parte.id} className="flex items-center gap-3 rounded-xl px-3 py-2.5" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border)' }}>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    {processo.advogados.map(adv => (
                      <div key={adv.id} className="flex items-center gap-3 rounded-xl px-3 py-2.5" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border)' }}>
              ...
              {processo.observacoes && (
                <div>
                  ...
                  <p className="text-sm leading-relaxed p-3 rounded-xl" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border)', color: 'var(--text-secondary)', whiteSpace: 'pre-wrap' }}>{processo.observacoes}</p>
                </div>
              )}
            ...
            <div className="p-6 space-y-4">
              ...
              {processo.numeroCnj ? (
                ...
                >
                  ...
                  <span>
                    Processo vinculado ao CNJ — o número e as partes são gerenciados automaticamente pelo DataJud.<br />
                    <span style={{ color: 'var(--text-muted)' }}>Para editar as partes, acesse a aba Dados do Processo.</span>
                  </span>
                </div>
              ) : (
                /* Cliente — apenas para processos manuais */
                <div>
