...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-gold-gradient">
      {/* ─── Painel esquerdo (decorativo) ─────────── */}
      <div
        className="hidden lg:flex flex-col justify-between p-12 w-1/2"
        style={{ background: 'rgba(10,10,10,.8)', backdropFilter: 'blur(24px) saturate(1.3)', WebkitBackdropFilter: 'blur(24px) saturate(1.3)', borderRight: '1px solid var(--border)' }}
      >
