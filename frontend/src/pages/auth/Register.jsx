    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: 'var(--bg-primary)' }}>
      <div className="w-full max-w-lg">
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* ─── Termos de Uso ────────────────────── */}
            <div className="rounded-xl p-4 border" style={{ background: 'var(--bg-tertiary)', borderColor: 'var(--border)' }}>
      ...
      {showTermos && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,.85)', backdropFilter: 'blur(6px)' }}>
          <div className="w-full max-w-2xl rounded-2xl overflow-hidden animate-scaleIn" style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border)' }}>
            <div className="flex justify-between items-center px-6 py-4 border-b sticky top-0" style={{ borderColor: 'var(--border)', background: 'var(--bg-secondary)' }}>
