...
function ModalNovoPrazo({ onClose, onSave, isPending }) {
  const [form, setForm] = useState({ titulo: '', descricao: '', dataVencimento: '', tipo: 'PROCESSUAL' });
  ...
  return createPortal(
    ...
    >
      <div className="animate-scaleIn" style={{ background: '#131a2b', border: '1px solid rgba(255,255,255,.1)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-gold)', width: '100%', maxWidth: 520, overflow: 'hidden', margin: 'auto' }}>
        ...
        <div style={{ padding: '1.25rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <select className="input-base" style={{ fontSize: '0.875rem' }} value={form.tipo} onChange={set('tipo')}>
        ...
        <div style={{ padding: '1rem 1.5rem', borderTop: '1px solid var(--border)', display: 'flex', justifyContent: 'flex-end', gap: '0.5rem', background: 'var(--bg-secondary)' }}>
...
function ModalDetalhe({ prazo, onClose, onCumprir, onDelete, isCumprindo, isDeletando }) {
  ...
  return createPortal(
    ...
    >
      <div className="animate-scaleIn" style={{ background: '#131a2b', border: '1px solid rgba(255,255,255,.1)', borderRadius: 'var(--radius-lg)', width: '100%', maxWidth: 480, overflow: 'hidden' }}>
        <div style={{ padding: '1.25rem 1.5rem 1rem', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
        ...
        <div style={{ padding: '1.25rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <span style={{ fontSize: '0.75rem', padding: '0.2rem 0.5rem', borderRadius: 4, background: 'var(--bg-tertiary)', border: '1px solid var(--border)', color: 'var(--text-muted)', fontWeight: 600 }}>
                {prazo.tipo}
              </span>
            </div>
          </div>
      ...
      {prazos.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
          ...
          {pendentes.map((prazo, i) => {
            ...
            const bgColor = vencido ? 'rgba(239,68,68,0.05)' : urgente ? 'rgba(245,158,11,0.05)' : 'var(--bg-tertiary)';
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.25rem', fontSize: '0.75rem', flexWrap: 'wrap' }}>
                    ...
                    <span style={{ fontSize: '0.65rem', padding: '0.15rem 0.45rem', borderRadius: 4, background: 'var(--bg-secondary)', border: '1px solid var(--border)', color: 'var(--text-muted)', fontWeight: 600, letterSpacing: '0.04em' }}>
                      {prazo.tipo}
                    </span>
                  </div>
                </div>
