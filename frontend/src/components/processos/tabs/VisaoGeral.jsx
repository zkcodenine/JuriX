      ...
      <div className="space-y-5">
        ...
        {tarefas.length > 0 && (
          <div>
            ...
            <div className="space-y-2">
              {tarefas.map(t => (
                <div key={t.id} className="flex items-center gap-3 rounded-xl px-3 py-2.5" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border)', borderLeft: `3px solid ${prioridadeColor[t.prioridade]}` }}>
        ...
        {prazos.length > 0 && (
          <div>
            ...
            <div className="space-y-2">
              {prazos.map(p => (
                <div key={p.id} className="flex items-center gap-3 rounded-xl px-3 py-2.5" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border)' }}>
...
function ParteBadge({ parte, cor, label }) {
  return (
    <div className="flex items-center gap-3 rounded-xl px-3 py-2.5" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border)', borderLeft: `3px solid ${cor}` }}>
      <div>
